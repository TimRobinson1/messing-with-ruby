...
class Defeat
  def initialize(enemy)
    ...
    messages = ["That #{version} #{enemy} made very quick work of you!", "That's not good, that #{enemy} was #{version}. Too bad for you.", "You really thought you could beat that #{version} #{enemy}?", "Ouch, that #{enemy} pulverized you.", "Dead! Hopefully the #{enemy} will make funeral arrangements too."]
